...
annotation_file = os.path.join(data_dir, 'mscoco_%s_annotations.json')
question_file = os.path.join(data_dir, 'OpenEnded_mscoco_%s_questions.json')
...
np.save(os.path.join(imdb_dir, 'imdb_trainval2014.npy'), np.array(imdb_train2014 + imdb_val2014))
