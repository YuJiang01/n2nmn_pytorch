...
question_file_trn = os.path.join(question_dir, 'CLEVR_train_questions.json')
save_file_trn = os.path.join(out_dir, 'CLEVR_train_questions_gt_layout.json')
...
question_file_val = os.path.join(question_dir, 'CLEVR_val_questions.json')
save_file_val = os.path.join(out_dir, 'CLEVR_val_questions_gt_layout.json')
...
question_file_tst = os.path.join(question_dir, 'CLEVR_test_questions.json')
save_file_tst = os.path.join(out_dir,'CLEVR_test_questions_gt_layout.json')
